...
def findMaxExpenses(salary, save, preRetireGrowthRates, postRetireGrowthRates,
    ...
    savings=max(F1) #El valor del ahorro, es el acumulado del último año. ambos valores son constantes, solo dependen del salario y de las tasas de crecimiento.
